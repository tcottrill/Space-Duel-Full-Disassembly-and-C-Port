...
| section | keys |
|---|---|
| `[main]` | `fps_lock` — 0 (the default) is the board's own 61.5 Hz; 60 underclocks the whole machine 2.48% so every frame lands on a 60 Hz panel (see the root README). `vsync` — 0 or 1 |
